...
import AprenderLibrasScreen from "../screens/aprender-libras/AprenderLibrasScreen";
import AlfabetoScreen from "../screens/aprender-libras/AlfabetoScreen";
import NumerosScreen from "../screens/aprender-libras/NumerosScreen";
import CumprimentosScreen from "../screens/aprender-libras/CumprimentosScreen";
    ...
    return (
        ...
        >
            <Drawer.Group>
                ...
                <Drawer.Screen
                    name="AprenderLibras"
                    component={AprenderLibrasScreen}
                    options={{
            ...
            <NavigationContainer>
                <Stack.Navigator>
                    <Stack.Group>
                        ...
                        />
                        {/* Telas acessadas pelos cards */}
                        <Stack.Screen
                            name="AlfabetoScreen"
                            component={AlfabetoScreen}
                            options={{ title: "Alfabeto" }}
                        />
                        <Stack.Screen
                            name="NumerosScreen"
                        ...
                        />
                        <Stack.Screen
                            name="CumprimentosScreen"
                            component={CumprimentosScreen}
                            options={{ title: "Cumprimentos" }}
                        />
                    </Stack.Group>
                </Stack.Navigator>
            </NavigationContainer>
